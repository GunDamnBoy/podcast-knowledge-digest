...
- **新增 `MAINTENANCE.md` 第 12 節「版本登記簿」**：13 場維護的速查表——動了哪些檔案、想解決什麼、**後來成立嗎**。最後一欄標出三次「修法本身製造新問題」的案例（08-04→08-06、08-03→08-03⑤、08-06①→08-06②），動防護機制前要先看。第 11 節仍是敘事體的來龍去脈，兩者互補。
